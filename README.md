...
Use the correct GitHub URL to clone the project:

```bash
git clone [https://github.com/KaijuBytes/business-lookup-AI](https://github.com/KaijuBytes/business-lookup-AI)
...
Create a .env file: Create a file named .env in the project root directory. If you plan to use the Google Gemini API, add your API key to this file:

# .env file content
GOOGLE_API_KEY="YOUR_GOOGLE_API_KEY_HERE"
Install Ollama (Optional for Local LLM): If you choose to run the LLM locally, download and install Ollama. After installation, pull the required model (e.g., Llama 3) in your terminal:
